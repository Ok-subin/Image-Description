...
public:
	...
	void colorRecognition(int, int, int, string resultArray[3][100] , int imageIndex);
	void mainExe(string bbImageName, string saveSegmentImage, string saveColorImage,string resultArray[3][100], int imageIndex);
};